...
class ImageMapper {
  ...
  List<Image> mapImageDtos(List<ImageDto> imageDtos) => imageDtos.map(mapDtoToImage).toList();
  ...
  List<ImageDto> mapImagesToDtos(List<Image> images) => images.map(mapImageToDto).toList();

  Image mapImageFromDatabase(database.Image dto) => Image(
        data: dto.data,
        name: dto.name,
        path: dto.path,
        uploadDate: dto.uploadDate,
